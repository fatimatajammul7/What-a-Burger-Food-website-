<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TrackOrder.aspx.cs" Inherits="WhataBurger.TrackOrder" %>
...
<body>
    ...
    <div>
           <div class="header">
            ...
            <div class="Right">
                <asp:Button ID="Button1" runat="server" Text="Sign Up" BackColor="#502314" BorderStyle="None" CssClass="Right" Font-Bold="True" Font-Names="Arial" ForeColor="#F5EBDC" Height="36px" Width="101px" />
                </div>
            </div>
            ...
            <div class="Mid">
                ...
                <asp:Button ID="Button2" runat="server" Text="Track" OnClick="Button2_Click" />
                <br /><br />
