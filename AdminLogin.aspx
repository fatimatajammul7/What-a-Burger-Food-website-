<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminLogin.aspx.cs" Inherits="WhataBurger.AdminLogin" %>
    ...
    <div class="header">
        ...
        <div class="Mid">
            <div class="nav">
                ...
                <a href="AdminTracking.aspx" >Order Status</a>
                
            </div>
        </div>
        <div class="Right">
            <asp:Button ID="Button1" runat="server" Text="Sign Up" ForeColor="#F5EBDC" BackColor="#502314" Height="33px" Width="72px" OnClick="Button1_Click" />
        </div>
    </div>
