<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ConfirmOrder.aspx.cs" Inherits="WhataBurger.ConfirmOrder" %>
...
<body>
    ...
    <div class="header">
        ...
        <div class="Addtocart">
            <br /><br /><br /><br />
            <asp:Button ID="Button3" runat="server" Text="CheckOut" OnClick="AddButton6_Click" />
            <br /><br /><br /><br />
